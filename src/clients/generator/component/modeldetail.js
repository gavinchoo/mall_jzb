...
import {Layout, Form, Modal, Row, Col, Card, Icon, message} from 'antd';
...
const Columns = [
    ...
    },
    {
        ...
        f7: {
            "columns": [
                {"title": "字段名称", "dataIndex": "title", "key": "title", "required": true, "width": 60},
                {"title": "字段别名", "dataIndex": "dataIndex", "key": "dataIndex", "required": true, "width": 60},
...
const Columns1 = [
    {"title": "字段名称", "dataIndex": "title", "key": "title", "type": String, "required": true, width: 60},
    {"title": "字段别名", "dataIndex": "dataIndex", "key": "dataIndex", "type": String, "required": true, width: 60},
    {
        "title": "字段类型", "dataIndex": "type", "key": "type", "type": String, "required": false,
        f7: {
            source: "category", dataSource: ["String", "Number", "Boolean", "Object", "Array"]
        }
    },
    {
        "title": "数据来源", "dataIndex": "source", "key": "source", "type": Object, "required": false,
        f7: {
            source: "category",
            dataSource: [
    ...
    {
        "title": "固定列表", "dataIndex": "category", "key": "category", "type": Object, "required": false, f7: {
        source: "other_busi",
        ...
        table: "category", columns: [
            ...
            {title: "枚举名称", dataIndex: "name", key: "name", type: String, required: true, width: 60},
        ], showFiled: "title"
    }
    },
    {
        "title": "其他业务单元", "dataIndex": "table", "key": "table", "type": Object, "required": false, f7: {
        source: "other_busi",
        query: "/api/generator/table/query",
        table: "table", columns: [
            {title: "业务单元别名", dataIndex: "title", key: "title", type: String, required: true, width: 60},
            {title: "业务单元名称", dataIndex: "name", key: "name", type: String, required: true, width: 60},
        ], showFiled: "title"
    }
    },
