...
module.exports = {
    init: function (app, auth) {
        app.post('/file/upload', storage, this.uploadPicture)
        app.get('/file/download', this.downloadPicture)
        app.all('/file/remove', this.removePicture)
        app.all('/file/query', this.queryPicture)
        app.all('/file/bind', this.bindPicture)
    },
